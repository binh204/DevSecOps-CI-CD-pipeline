            ...
            steps {
                ...
                script {
                    ...
                    sh """
                        ...
                        curl -s -u ${SONARQUBE_TOKEN}: "http://192.168.73.36:9000/api/qualitygates/project_status?projectKey=DevSecOps" | jq . || echo "API check failed - continuing..."
                    """
                }
            }
        }
        ...
        stage('OWASP ZAP Baseline Scan') {
            steps {
                ...
                sh '''
                    ...
                    echo "Checking if application is ready for ZAP scan..."
